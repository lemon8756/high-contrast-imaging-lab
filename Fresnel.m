...
% Created by:   High-Contrast Imaging Laboratory @ Princeton Univ.
% Modified by:  Alexis Carlotti on Feb 17 2012
% Modified by:  Aaron Lemmer on May 17 2012
...
if trigger==0
    ...
    [XI,ETA] = meshgrid(xi);   %creates square (xi by xi) grid of (xi,yi)e
